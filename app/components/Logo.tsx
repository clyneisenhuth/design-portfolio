export default function Logo({ className = "h-10 w-auto" }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 720 220" className={className} aria-label="CLE logo">
      ...
      <text x="218" y="38" fontFamily="'JetBrains Mono', ui-monospace, monospace" fontSize="13" fontWeight="500" letterSpacing="2" fill="#8059C4" fillOpacity="0.55" textAnchor="end">01</text>
      <text x="140" y="154" fontFamily="Fredoka, ui-sans-serif, system-ui" fontWeight="700" fontSize="148" letterSpacing="-6" fill="#8059C4" textAnchor="middle">C</text>
      ...
      <text x="658" y="38" fontFamily="'JetBrains Mono', ui-monospace, monospace" fontSize="13" fontWeight="500" letterSpacing="2" fill="#4B7BE5" fillOpacity="0.55" textAnchor="end">03</text>
      <text x="580" y="154" fontFamily="Fredoka, ui-sans-serif, system-ui" fontWeight="700" fontSize="148" letterSpacing="-6" fill="#4B7BE5" textAnchor="middle">E</text>
      <g transform="translate(688 86) scale(1.2)">
        <path d="M 0 -16 C 1.6 -4.8 4.8 -1.6 16 0 C 4.8 1.6 1.6 4.8 0 16 C -1.6 4.8 -4.8 1.6 -16 0 C -4.8 -1.6 -1.6 -4.8 0 -16 Z" fill="#8059C4"/>
      </g>
    </svg>
  );
}
